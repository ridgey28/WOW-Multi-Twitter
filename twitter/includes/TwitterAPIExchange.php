...
class TwitterAPIExchange
{
     ...
     * @return \TwitterAPIExchange Instance of self for method chaining
     */
    public function setGetfield(array $get_params)
    {
        ...
        $this->getfield = '?' . http_build_query($get_params, '', '&');
     ...
     */
    public function request($url, $method = 'get', $data = array(), $curlOptions = array())
    {
